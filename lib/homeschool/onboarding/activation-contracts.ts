...
export const ACTIVATION_EVENT_NAMES = {
  ...
  todayLessonBuildQueued: "today_lesson_build_queued",
  todayLessonBuildStarted: "today_lesson_build_started",
  todayLessonBuildCompleted: "today_lesson_build_completed",
  todayLessonBuildFailed: "today_lesson_build_failed",
  todayActivityBuildQueued: "today_activity_build_queued",
