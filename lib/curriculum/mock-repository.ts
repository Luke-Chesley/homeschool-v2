...
const seedUnits: CurriculumUnit[] = [
  ...
  },
  {
    id: SEED_UNIT_2_ID,
    sourceId: SEED_SOURCE_ID,
    unitRef: "unit:multiplication-division",
...
const seedLessons: CurriculumLesson[] = [
  {
    ...
    unitRef: "unit:whole-numbers",
    lessonRef: "lesson:numbers-to-10000",
    lessonType: "task",
    ...
    linkedSkillRefs: ["skill:singapore-math-4a/whole-numbers/read-write-10000"],
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    unitId: SEED_UNIT_1_ID,
    unitRef: "unit:whole-numbers",
    lessonRef: "lesson:numbers-to-100000",
    lessonType: "task",
    ...
    linkedSkillRefs: ["skill:singapore-math-4a/whole-numbers/place-value-100000"],
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    unitRef: "unit:multiplication-division",
    lessonRef: "lesson:multiply-by-1-digit",
    lessonType: "task",
    ...
    linkedSkillRefs: ["skill:singapore-math-4a/multiplication-division/multiply-1-digit"],
    createdAt: now,
    updatedAt: now,
  },
];
...
class InMemoryCurriculumRepository implements CurriculumRepository {
  ...
  async updateLesson(id: string, patch: Partial<CreateCurriculumLessonInput>): Promise<CurriculumLesson> {
    ...
    const updated = {
      ...
      linkedSkillRefs: patch.linkedSkillRefs ?? existing.linkedSkillRefs,
      updatedAt: this.ts(),
    };
