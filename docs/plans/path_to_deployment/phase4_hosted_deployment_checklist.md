...
- [ ] Create the hosted staging Supabase project.
- [ ] Create the hosted production Supabase project.
- [ ] Record each project ref, project URL, Studio URL, publishable key, service role key, and database connection string.
- [ ] Confirm auth and storage are enabled on both projects.
...
- [ ] Complete [phase4_env_matrix.md](/home/luke/Desktop/homeschool-v2/docs/plans/path_to_deployment/phase4_env_matrix.md) with actual hosted values and owners.
...
- [ ] Document the exact staging migration rollout path.
- [ ] Document the exact production migration rollout path.
...
- [ ] Record any migration risks that still depend on runtime-boot migration behavior.
...
- [ ] Phase 3 RLS verification assumptions still hold in hosted staging.
- [ ] Supabase Security Advisor is checked against the staged hosted project.
...
- [ ] Update [docs/plans/path_to_deployment/README.md](/home/luke/Desktop/homeschool-v2/docs/plans/path_to_deployment/README.md) as Phase 4 starts and finishes.
- [ ] Keep [phase4_hosted_deployment_setup.md](/home/luke/Desktop/homeschool-v2/docs/plans/path_to_deployment/phase4_hosted_deployment_setup.md) current if implementation decisions change.
- [ ] Keep [phase4_env_matrix.md](/home/luke/Desktop/homeschool-v2/docs/plans/path_to_deployment/phase4_env_matrix.md) current with actual hosted values.
