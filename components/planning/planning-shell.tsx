...
export function PlanningShell({
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 pb-16 pt-8 sm:px-8 lg:px-10">
      <section className="relative overflow-hidden rounded-[2rem] border border-border/70 bg-card/85 px-6 py-10 shadow-[0_36px_120px_-54px_rgba(34,42,41,0.45)] backdrop-blur sm:px-8 lg:px-10">
