...
export function GraphSurface({ spec }: ComponentRendererProps<InteractiveWidgetComponent>) {
  return (
    <div className="flex flex-col gap-2 rounded-xl border border-border bg-muted/20 p-4 text-sm">
      ...
      <p className="text-xs text-muted-foreground">
        Graph surface scaffolding is reserved for backend-engine backed plotting tasks.
      </p>
    </div>
  );
}
