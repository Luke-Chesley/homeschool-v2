  ...
  return (
    <div className={cn("grid gap-1.5", className)}>
      ...
      <select
        ...
        aria-label={label}
        className={cn(
          "min-w-0 rounded-lg border border-border/70 bg-background/85 px-3 py-2 text-sm text-foreground outline-none transition focus:ring-2 focus:ring-ring/60 disabled:cursor-not-allowed disabled:opacity-60",
          selectClassName,
        )}
      >
